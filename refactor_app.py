...
class ApplicationWindow(tk.Frame):
    ...
    def gui_setup(self, hit_function, stand_function):
        self.configure_parent()
        self.create_and_configure_frms()
        self.create_and_configure_lbls()
        self.create_and_configure_btns(hit_function, stand_function)
    ...
    def create_and_configure_btns(self, hit_function, stand_function):
        btn_hit = tk.Button(master=self.frm_btns, text='Hit', command=hit_function)
        btn_stand = tk.Button(master=self.frm_btns, text='Stand', command=stand_function)    
